...
class Block(object):
    ...
    Store transactions in Blockchain that supports a cryptocurrecy.
    '''
    ...
    def to_json(self):
        '''
        Serialize the block into python dictionaries
        '''
    ...
    def adjust_difficulty(last_block, new_timestamp):
        '''
        Calculate the adjusted difficulty basd on the MINE_RATE.
...
def main():
    ...
    bad_block.last_hash = 'wrong_hash'
    try:
